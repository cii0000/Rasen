...
struct FormantFilter: Hashable, Codable {
    /// f0: 4.03
    var formants: [Formant] = [.init(sdVolm: 0.5 * 0.8 * 0.85, sdNoise: 0,
                                     sdPitch: 9.1, sPitch: 67.8, ePitch: 74.5, edPitch: 6.3,
                                     volm: 0.9 * 0.8 * 0.85, noise: 0.13,
                                     edVolm: 0.5 * 0.8 * 0.85, edNoise: 0.18),
                               .init(sdVolm: 0.5 * 0.85 * 0.85, sdNoise: 0.13,
                                     sdPitch: 5.7, sPitch: 80, ePitch: 81.7, edPitch: 5.2,
                                     volm: 0.9 * 0.85 * 0.85, noise: 0.3,
                                     edVolm: 0.33 * 0.85 * 0.85, edNoise: 0.26),
                               .init(sdVolm: 0.3 * 0.9 * 0.85, sdNoise: 0.23,
                               ...
                               .init(sdVolm: 0, sdNoise: 1,
                                     ...
                                     volm: 0.3 * 0.9 * 0.9, noise: 0.61,
                                     edVolm: 0.1 * 0.9 * 0.9, edNoise: 1),
                               .init(sdVolm: 0.1 * 0.9 * 0.9, sdNoise: 1,
                                     sdPitch: 0.6, sPitch: 113.7, ePitch: 115.3, edPitch: 0.8,
                                     volm: 0.2 * 0.9 * 0.9, noise: 0.93,
                                     edVolm: 0, edNoise: 1)]
    
    /// f0: 4.00
    static let low = Self(formants: [.init(sdVolm: 0.5 * 0.8 * 0.85, sdNoise: 0,
                                     sdPitch: 9.1, sPitch: 67.8, ePitch: 74.5, edPitch: 6.3,
                                     volm: 0.9 * 0.8 * 0.85, noise: 0.13,
                                     edVolm: 0.5 * 0.8 * 0.85, edNoise: 0.18),
                               .init(sdVolm: 0.5 * 0.85 * 0.85, sdNoise: 0.13,
                                     ...
                                     volm: 0.9 * 0.85 * 0.85, noise: 0.3,
                                     edVolm: 0.33 * 0.85 * 0.85, edNoise: 0.26),
                               .init(sdVolm: 0.2 * 0.75 * 0.85, sdNoise: 0.23,
                                     sdPitch: 1.6, sPitch: 94.5, ePitch: 96.5, edPitch: 1.1,
                                     volm: 1, noise: 0.35,
                               ...
                               .init(sdVolm: 0, sdNoise: 1,
                                     sdPitch: 0.8, sPitch: 107.9, ePitch: 109.6, edPitch: 0.9,
                                     volm: 0.3 * 0.9 * 0.9, noise: 0.65,
                                     edVolm: 0.1 * 0.9 * 0.9, edNoise: 1),
                               .init(sdVolm: 0.1 * 0.9 * 0.9, sdNoise: 1,
                                     sdPitch: 0.6 * 0.9, sPitch: 113.7, ePitch: 115.3, edPitch: 0.8,
                                     volm: 0.2 * 0.9 * 0.9, noise: 0.95,
                                     edVolm: 0, edNoise: 1)])
}
