...
//        case .moveZ: MoveZAction(self)
    ...
    private func inputKeyAction(with gesture: Gesture) -> (any InputKeyEventAction)? {
        ...
        case .goPrevious: GoPreviousFrameAction(self)
        case .goNext: GoNextFrameAction(self)
        case .goPreviousKeyframe: GoPreviousKeyframeAction(self)
        case .goNextKeyframe: GoNextKeyframeAction(self)
