...
extension Color {
    ...
    static let previous = Color(red: 1, green: 0.925, blue: 0.925)
    static let next = Color(red: 0.875, green: 1, blue: 0.825)
    ...
    static let subInterpolated = Color(white: 0.5, opacity: 0.25)
